...
WsFedSaml2Strategy.prototype._authenticate_saml_bearer = function (req, state) { 
  var self = this;
...
WsFedSaml2Strategy.prototype.authenticate = function (req, optns) {
  var opts = xtend({}, optns); // Copy options to avoid wctx race
  var self = this;
